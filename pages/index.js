...
const projects = ({ ids }) => {
    ...
    return ( 
        <div className='flex flex-col justify-items-center bg-custom-background'>
            <ProjectCard projectId={ids[0]} project={myProjects[0]} objectFit='object-left' objectScaling='object-scale-down' />
            <ProjectCard projectId={ids[1]} project={myProjects[6]} objectFit='object-left' objectScaling='object-scale-down' />
            <ProjectCard projectId={ids[2]} project={myProjects[2]} objectFit='object-left' objectScaling='object-scale-down' />
            <ProjectCard projectId={ids[3]} project={myProjects[7]} objectFit='object-left' objectScaling='object-scale-down' />
            <ProjectCard projectId={ids[4]} project={myProjects[4]} objectFit='object-left' objectScaling='object-scale-down' />
            <ProjectCard projectId={ids[5]} project={myProjects[5]} objectFit='object-left' objectScaling='object-scale-down' />
            <ProjectCard projectId={ids[6]} project={myProjects[1]} objectFit='object-left' objectScaling='object-scale-down' />
            <ProjectCard projectId={ids[7]} project={myProjects[3]} objectFit='object-left' objectScaling='object-scale-down' />
            <ProjectCard projectId={ids[8]} project={myProjects[8]} objectFit='object-left' objectScaling='object-scale-down' />
        </div>
    )
}
